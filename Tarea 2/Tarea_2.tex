\documentclass[fleqn]{article}                       %Con fleqn las ecuaciones se alinean a la izquierda
\usepackage{amsmath, amssymb}
\usepackage[spanish, english]{babel}
\usepackage{parskip, nopageno}                       %Con nopageno no se enumeran las páginas
\usepackage[a4paper, margin = 2.1cm]{geometry}       %Tamaño de hoja y margenes de cada una
...
\begin{document}
    ...
    \begin{titlepage}
        ...
        \vspace{0.7cm}
        \vfill
        \raggedleft{\LARGE Fecha de Entrega: 9 de septiembre de 2022}\par         %Alinear a la derecha
    \end{titlepage}
    ...
    \begin{enumerate}
        ...
        \begin{enumerate}
            ...
            \hspace{2.7mm}  Dem. \par
            %minipage sirve para dividir en columnas
            %[c,t] indica la posición del texto
            %{*distancia*} indica el ancho de la columna
