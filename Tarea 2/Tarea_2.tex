        ...
        \begin{enumerate}
            ...
            \begin{enumerate}
                ...
                \begin{equation*}
                    ...
                    \Longrightarrow a = 0
                \end{equation*}
                Así, por (\ref{eq:dos}), se tiene que b = -a = -0 = 0. Y por (\ref{eq:tres}) c = \frac{a}{2} = \frac{0}{2} = 0. De esta manera, (a,b,c) = (0,0,0) = \overline{0}. \par
                ...
                $ \therefore \left \{\ooverline{0}\right \}
